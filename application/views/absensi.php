...
//-->
            ...
            <div id="content" class="login">
                ...
                <?php if($this->session->flashdata('psnerror')){?>
                <div class="notif tip">
                    <?php echo $this->session->flashdata('psnerror');?>
                    <a href="#" class="close"></a>
                </div>
                <?php }?>

                <?php echo form_open('absensi/input_absensi');?>

                <div class="input placeholder">
                    <label for="absen">ID</label>
                    <input type="text" name="iduser" id="absen"/>
                </div>
