...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>js/jwysiwyg/jquery.wysiwyg.old-school.css" />
        <script type="text/javascript" src="<?php echo base_url();?>js/jwysiwyg/jquery.wysiwyg.js"></script>

        
        
        <!-- Tooltipsy - http://tooltipsy.com/ -->
        <script type="text/javascript" src="<?php echo base_url();?>js/tooltipsy.min.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url();?>js/zoombox/zoombox.js"></script>

        <link rel="stylesheet" href="<?php echo base_url();?>js/zoombox/zoombox.css" />
        ...
        <!-- Notifikasi -->
        <script type="text/javascript" src="<?php echo base_url();?>js/notifikasi.js"></script>
    ...
    <body class="white">
        ...
        <div id="head">
            <div class="left">
                <a href="" class="button profile"><img src="<?php echo base_url();?>img/icons/huser.png" alt="" /></a>
                Hi, 
                <a href="#"><?php echo $user = $this->session->userdata('user');?></a>
                |
                <a href="<?php echo base_url();?>index.php/user_proses/logout">Logout</a>
                |
                <span id="pesan">
                 Pesan
                <span id="notifikasi"></span>
                 ...
                 <div id="info">
                  <div id="loading"><br>Loading...<img src="<?php echo base_url();?>img/loading.gif"></div>
                  <div id="konten-info">
                  </div>
                 </div>    
        ...
        <div id="sidebar">
            ...
            <ul>
                <li class="nosubmenu">
                    <a href="<?php echo base_url();?>index.php/user_proses/op_dashboard">
                        <img src="<?php echo base_url();?>img/icons/menu/black-dashboard.png" alt="" />
                        Dashboard
                    </a>
                </li>
         
                <li><a href="#"><img src="<?php echo base_url();?>img/icons/menu/black-layout.png" alt="" /> Menu&nbsp;::&nbsp;Operator</a>
                    <ul>
                                                <li><a href="<?php echo base_url();?>index.php/user_proses/op_dashboard">Dashboard</a></li>
                                                <li><a href="<?php echo base_url();?>index.php/pasien/register">Register</a></li>
                                                <li><a href="<?php echo base_url();?>index.php/apotek">Data Obat</a></li>
            ...
            <?php }else if($this->session->userdata('level') == 2){ ?>
             <ul>
                <li class="nosubmenu">
                    <a href="<?php echo base_url();?>index.php/user_proses/dok_dashboard">
                        <img src="<?php echo base_url();?>img/icons/menu/black-dashboard.png" alt="" />
                        Dashboard
                    </a>
                </li>

                <li><a href="#"><img src="<?php echo base_url();?>img/icons/menu/black-layout.png" alt="" /> Menu&nbsp;::&nbsp;Dokter</a>
                    <ul>
                    <li><a href="<?php echo base_url();?>index.php/user_proses/dok_dashboard">Dashboard</a></li>
                    <li><a href="<?php echo base_url();?>index.php/dokter/trans_pengguna">Pengguna</a></li>
		    <li><a href="<?php echo base_url();?>index.php/daftar_pemeriksaan">Daftar Pemeriksaan</a></li>
                    <li><a href="<?php echo base_url();?>index.php/apotek">Data Obat</a></li>
                    </ul>
                </li>
            </ul>
